		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="fechaCreacion" title="${message(code: 'usuario.fechaCreacion.label', default: 'Fecha Creacion')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${usuarioInstance.fechaCreacion}" /></td>
