<%@ page import="abogadoexpresspuntonet.Rol" %>
...
<div class="fieldcontain ${hasErrors(bean: rolInstance, field: 'nombre', 'error')} required">
	...
	<g:textField name="nombre" maxlength="20" required="" value="${rolInstance?.nombre}"/>
...
<div class="fieldcontain ${hasErrors(bean: rolInstance, field: 'descripcion', 'error')} required">
	...
	<g:textField name="descripcion" maxlength="60" required="" value="${rolInstance?.descripcion}"/>
